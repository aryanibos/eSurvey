...
<head>
    ...
    <title>Quisioner Ibu Hamil</title>
    ...
    <link rel="stylesheet" href="{{ asset('template') }}/assets/plugins/icons/flags/flags.css">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                                    <a class="nav-link" class="btn btn-info follow-btns"
